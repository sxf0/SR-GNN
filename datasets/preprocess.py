...
with open(dataset, "r") as f:
    ...
    for data in reader:
        ...
        if curdate and not curid == sessid:
            ...
            if opt.dataset == 'yoochoose':
                ...
                date = time.mktime(time.strptime(curdate, '%Y-%m-%d'))  #将even_date转换为浮点数
    ...
    if opt.dataset == 'yoochoose':
        ...
        date = time.mktime(time.strptime(curdate, '%Y-%m-%d')) #将curdate转换为浮点数
...
if opt.dataset == 'diginetica':
    ...
    print(pickle.load(open('sample/train.txt', 'rb')))
